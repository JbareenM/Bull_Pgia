...
int main() {
    ...
    if (signal == 0) {
        ...
        .CHECK_OUTPUT(calculateBullAndPgia("78977298798","78955265658"), "5,0")
        .CHECK_OUTPUT(calculateBullAndPgia("2324","1234"), "1,2")
        .CHECK_OUTPUT(calculateBullAndPgia("123456789","765432189"), "3,6")
        .CHECK_OUTPUT(calculateBullAndPgia("123456789","000000087"), "1,1")
        .CHECK_OUTPUT(calculateBullAndPgia("324567095","325798560"), "2,6")
        .CHECK_OUTPUT(calculateBullAndPgia("1947","1767"), "2,0")
        .CHECK_OUTPUT(calculateBullAndPgia("34528","27837"), "0,3")
        .CHECK_OUTPUT(calculateBullAndPgia("31257","89843"), "0,1")
        .CHECK_OUTPUT(calculateBullAndPgia("5453","4354"), "1,2")
        .CHECK_OUTPUT(calculateBullAndPgia("3789","2389"), "2,1")
        .CHECK_OUTPUT(calculateBullAndPgia("2314","9842"), "0,2")
        .CHECK_OUTPUT(calculateBullAndPgia("3278","3844"), "1,1")
        .CHECK_OUTPUT(calculateBullAndPgia("93489","83478"), "2,1")
        .CHECK_OUTPUT(calculateBullAndPgia("38478","38478"), "5,0")
        .CHECK_OUTPUT(calculateBullAndPgia("29849","90485"), "0,3")
        .CHECK_OUTPUT(calculateBullAndPgia("987349","934889"), "2,3")
        .CHECK_OUTPUT(calculateBullAndPgia("384799","845989"), "1,3")
